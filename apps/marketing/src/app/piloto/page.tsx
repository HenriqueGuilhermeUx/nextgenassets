    ...
    <main className="min-h-screen bg-slate-950 px-6 py-10 text-white">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-6 rounded-[2rem] border border-white/10 bg-white/10 p-8 md:p-10">
          <div className="text-sm font-black uppercase tracking-[0.25em] text-emerald-300">Piloto NextGen</div>
          <h1 className="mt-4 max-w-4xl text-4xl font-black leading-tight md:text-6xl">Pronto para teste assistido com empresa.</h1>
          <p className="mt-5 max-w-4xl text-lg leading-8 text-white/65">Use esta página para validar o fluxo completo antes de apresentar para cliente ou parceiro.</p>
        ...
        <section className="mt-8 rounded-3xl border border-white/10 bg-white/10 p-6">
          <h2 className="text-3xl font-black">Atalhos principais</h2>
